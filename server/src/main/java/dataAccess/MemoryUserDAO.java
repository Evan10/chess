...
public class MemoryUserDAO implements UserDAO{
    ...
    public void addUser(UserData userData) throws DataAccessException {
        if(allUserData.containsKey(userData.username())) throw new DataAccessException("Username in use");
    ...
    public void updateUser(String username, UserData userData) throws DataAccessException {
        if(!allUserData.containsKey(username)) throw new DataAccessException("User not found");
        allUserData.put(userData.username(), userData);
    }
